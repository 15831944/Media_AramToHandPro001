...
namespace Examples
{
    class Program
    {
        ...
        {
            Console.WriteLine("CreateGCodeCommand  ");
            CreateGCodeCommand();
            Console.WriteLine("CreateCommandFromGCode");
            CreateCommandFromGCode();
            Console.WriteLine("GCodeFromMappedCommand");
            GCodeFromMappedCommand();
            Console.WriteLine("MappedCommandFromGCode");
