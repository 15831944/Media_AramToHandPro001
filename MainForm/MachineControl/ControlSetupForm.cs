...
namespace MainForm.MachineControl
{
    public partial class ControlSetupForm : Form
    {
        ...
        public void buttonColorsSeting()
        {
            SetupForm_Load(null, null);
            //setButtonColors(btnColorBackground, Properties.Settings.Default.colorBackground);
            //setButtonColors(btnColorRuler, Properties.Settings.Default.colorRuler);
            //setButtonColors(btnColorPenUp, Properties.Settings.Default.colorPenUp);
            //setButtonColors(btnColorPenDown, Properties.Settings.Default.colorPenDown);
        ...
        public void LoadDxfIni()
        {

            GlobalVarsbool.cblayer_0= cblayer_0.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_0", 255, "").ToLower()=="true";
           GlobalVarsbool.cblayer_Ddfpoints = cblayer_Ddfpoints.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_Ddfpoints", 255, "").ToLower() == "true";
           GlobalVarsbool.cblayer_DIM_SYMB = cblayer_DIM_SYMB.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_DIM_SYMB", 255, "").ToLower() == "true";
            GlobalVarsbool.cblayer_DQ_标注 = cblayer_DQ_标注.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_DQ_标注", 255, "").ToLower() == "true";

            GlobalVarsbool.cblayer_DQ_电气 = cblayer_DQ_电气.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_DQ_电气", 255, "").ToLower() == "true";

           GlobalVarsbool.cblayer_GJ_钢筋 = cblayer_GJ_钢筋.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_GJ_钢筋", 255, "").ToLower() == "true";
           GlobalVarsbool.cblayer_LB_楼板 = cblayer_LB_楼板.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_LB_楼板", 255, "").ToLower() == "true";
           GlobalVarsbool.cblayer_OYGY = cblayer_OYGY.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_OYGY", 255, "").ToLower() == "true";
           GlobalVarsbool.cblayer_PUB_DIM = cblayer_PUB_DIM.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_PUB_DIM", 255, "").ToLower() == "true";
            GlobalVarsbool.cblayer_PUB_TEXT = cblayer_PUB_TEXT.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_PUB_TEXT", 255, "").ToLower() == "true";


           GlobalVarsbool.cblayer_S_BZ = cblayer_S_BZ.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_S_BZ", 255, "").ToLower() == "true";
           GlobalVarsbool.cblayer_TABLE = cblayer_TABLE.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_TABLE", 255, "").ToLower() == "true";
           GlobalVarsbool.cblayer_TEXT = cblayer_TEXT.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_TEXT", 255, "").ToLower() == "true";
           GlobalVarsbool.cblayer_TITLE = cblayer_TITLE.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_TITLE", 255, "").ToLower() == "true";
            GlobalVarsbool.cblayer_WQ_外墙 = cblayer_WQ_外墙.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_WQ_外墙", 255, "").ToLower() == "true";

           GlobalVarsbool.cblayer_WZ_文字 = cblayer_WZ_文字.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_WZ_文字", 255, "").ToLower() == "true";
           GlobalVarsbool.cblayer_受力钢筋 = cblayer_受力钢筋.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_受力钢筋", 255, "").ToLower() == "true";
           GlobalVarsbool.cblayer_叠合板方向 = cblayer_叠合板方向.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_叠合板方向", 255, "").ToLower() == "true";
           GlobalVarsbool.cblayer_图框 = cblayer_图框.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_图框", 255, "").ToLower() == "true";
            GlobalVarsbool.cblayer_文字 = cblayer_文字.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_文字", 255, "").ToLower() == "true";

           GlobalVarsbool.cblayer_普通钢筋 = cblayer_普通钢筋.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_普通钢筋", 255, "").ToLower() == "true";
           GlobalVarsbool.cblayer_目录名字_签名 = cblayer_目录名字_签名.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_目录名字_签名", 255, "").ToLower() == "true";
           GlobalVarsbool.cblayer_符号标注 = cblayer_符号标注.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_符号标注", 255, "").ToLower() == "true";
            GlobalVarsbool.cblayer_钢筋 = cblayer_钢筋.Checked = APPConfig.AppConfig.ReadIniString("LayerIni", "cblayer_钢筋", 255, "").ToLower() == "true";

            ///
            GlobalVarsbool.cb_Arc = cb_Arc.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_Arc", 255, "").ToLower() == "true";
            GlobalVarsbool.cb_Circle = cb_Circle.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_Circle", 255, "").ToLower() == "true";
            GlobalVarsbool.cb_Dimension = cb_Dimension.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_Dimension", 255, "").ToLower() == "true";
            GlobalVarsbool.cb_Ellipse = cb_Ellipse.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_Ellipse", 255, "").ToLower() == "true";
            GlobalVarsbool.cb_Face3D = cb_Face3D.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_Face3D", 255, "").ToLower() == "true";
            GlobalVarsbool.CB_Hatch = CB_Hatch.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "CB_Hatch", 255, "").ToLower() == "true";
            GlobalVarsbool.cb_Insert = cb_Insert.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_Insert", 255, "").ToLower() == "true";
            GlobalVarsbool.cb_Leader = cb_Leader.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_Leader", 255, "").ToLower() == "true";
            //
            GlobalVarsbool.cb_LightWeightPolyline = cb_LightWeightPolyline.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_LightWeightPolyline", 255, "").ToLower() == "true";
            GlobalVarsbool.cb_Line = cb_Line.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_Line", 255, "").ToLower() == "true";
            GlobalVarsbool.cb_Mesh = cb_Mesh.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_MText", 255, "").ToLower() == "true";
            GlobalVarsbool.cb_MText = cb_MText.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_MText", 255, "").ToLower() == "true";
            GlobalVarsbool.cb_Point = cb_Point.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_Point", 255, "").ToLower() == "true";
            GlobalVarsbool.cb_PolyfaceMesh = cb_PolyfaceMesh.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_PolyfaceMesh", 255, "").ToLower() == "true";
            GlobalVarsbool.cb_Polyline = cb_Polyline.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_Polyline", 255, "").ToLower() == "true";
            GlobalVarsbool.cb_Ray = cb_Ray.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_Ray", 255, "").ToLower() == "true";
            //
            GlobalVarsbool.cb_Shape = cb_Shape.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_Shape", 255, "").ToLower() == "true";
            GlobalVarsbool.cb_Solid = cb_Solid.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_Solid", 255, "").ToLower() == "true";
            GlobalVarsbool.cb_Spline = cb_Spline.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_Spline", 255, "").ToLower() == "true";
            GlobalVarsbool.cb_Text = cb_Text.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_Text", 255, "").ToLower() == "true";
            GlobalVarsbool.cb_Tolerance = cb_Tolerance.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_Tolerance", 255, "").ToLower() == "true";
            GlobalVarsbool.cb_Trace = cb_Trace.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_Trace", 255, "").ToLower() == "true";
            GlobalVarsbool.cb_Underlay = cb_Underlay.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_Underlay", 255, "").ToLower() == "true";
            GlobalVarsbool.cb_Viewport = cb_Viewport.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_Viewport", 255, "").ToLower() == "true";

            GlobalVarsbool.cb_Wipeout = cb_Wipeout.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_Wipeout", 255, "").ToLower() == "true";
            GlobalVarsbool.cb_XLine = cb_XLine.Checked = APPConfig.AppConfig.ReadIniString("CADcontentIni", "cb_XLine", 255, "").ToLower() == "true";
...
//            MessageBox.Show(opnDlg.InitialDirectory+"\r\n"+ Application.StartupPath);
        ...
        {
            // DXF图层配置
            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_0", cblayer_0.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_Ddfpoints", cblayer_Ddfpoints.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_DIM_SYMB", cblayer_DIM_SYMB.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_DQ_标注", cblayer_DQ_标注.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_DQ_电气", cblayer_DQ_电气.Checked.ToString(), "");

            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_GJ_钢筋", cblayer_GJ_钢筋.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_LB_楼板", cblayer_LB_楼板.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_OYGY", cblayer_OYGY.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_PUB_DIM", cblayer_PUB_DIM.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_PUB_TEXT", cblayer_PUB_TEXT.Checked.ToString(), "");

            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_S_BZ", cblayer_S_BZ.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_TABLE", cblayer_TABLE.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_TEXT", cblayer_TEXT.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_TITLE", cblayer_TITLE.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_WQ_外墙", cblayer_WQ_外墙.Checked.ToString(), "");


            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_WZ_文字", cblayer_WZ_文字.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_受力钢筋", cblayer_受力钢筋.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_叠合板方向", cblayer_叠合板方向.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_图框", cblayer_图框.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_文字", cblayer_文字.Checked.ToString(), "");


            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_普通钢筋", cblayer_普通钢筋.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_目录名字_签名", cblayer_目录名字_签名.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_符号标注", cblayer_符号标注.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("LayerIni", "cblayer_钢筋", cblayer_钢筋.Checked.ToString(), "");

            //dxf 文档内容配置
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_Arc", cb_Arc.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_Circle", cb_Circle.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_Dimension", cb_Dimension.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_Ellipse", cb_Ellipse.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_Face3D", cb_Face3D.Checked.ToString(), "");

            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "CB_Hatch", CB_Hatch.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_Insert", cb_Insert.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_Leader", cb_Leader.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_LightWeightPolyline", cb_LightWeightPolyline.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_Line", cb_Line.Checked.ToString(), "");

            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_Mesh", cb_Mesh.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_MLine", cb_MLine.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_MText", cb_MText.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_Point", cb_Point.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_PolyfaceMesh", cb_PolyfaceMesh.Checked.ToString(), "");

            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_Polyline", cb_Polyline.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_Ray", cb_Ray.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_Shape", cb_Shape.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_Solid", cb_Solid.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_Spline", cb_Spline.Checked.ToString(), "");

            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_Text", cb_Text.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_Tolerance", cb_Tolerance.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_Trace", cb_Trace.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_Underlay", cb_Underlay.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_Viewport", cb_Viewport.Checked.ToString(), "");

            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_Wipeout", cb_Wipeout.Checked.ToString(), "");
            APPConfig.AppConfig.WriteStringIni("CADcontentIni", "cb_XLine", cb_XLine.Checked.ToString(), "");
            //更新配置
            LoadDxfIni();
