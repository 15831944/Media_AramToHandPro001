...
namespace MainForm.DXFviwer
{
	...
	{
		public static Color Window_bgColor = Color.FromRgb(33,40,148);
		...
		public Canvas mainCanvas= new Canvas();//可以把Canvas比作一个坐标系,所有的元素通过设置坐标来决定其在坐标系中的位置.这个坐标系的原点并不是在中央,而是位于它的左上角
		...
		public static void GetCanvas(netDxf.DxfDocument DxfDoc,Canvas mainCanvas)
		{
			...
			/*Dessin Line*/
			Debug.WriteLine("nb ligne="+DxfDoc.Lines);
