...
namespace TestDxfDocument
{
   public class DataList
    {
        // 
        public string strG00 = "";
        public Command gcodeMake_G(CadLayer layer, string strcmd,int stepCount=-1)
        {
            var cmd = new Command(CommandType.G, 1);
            cmd.SetParameterValue(ParameterType.X, 10);
            cmd.SetParameterValue(ParameterType.Y, 20);
            cmd.SetParameterValue(ParameterType.Z, 10);
            ...
            return  Command.Parse("G1 X10 Y20");

        }

        public  string ToGCode(CommandType CommandType, Vector3 vector,  int lineNumber = -1)
        {
            ...
            var cmd = new Command(CommandType, 1);
            cmd.SetParameterValue(ParameterType.X, vector.X);
            cmd.SetParameterValue(ParameterType.Y, vector.Y);
            cmd.SetParameterValue(ParameterType.Z, vector.Z);
